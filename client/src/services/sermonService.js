...
const sermonService = {
  ...
  // Get all sermons (alias)
  getAllSermons: async (params = {}) => {
    return await sermonService.getAll(params);
  },

  // Get categories
  getCategories: async () => {
    return await api.get('/sermons/categories/list');
  },

  // Get speakers
  getSpeakers: async () => {
    return await api.get('/sermons/speakers/list');
  },
